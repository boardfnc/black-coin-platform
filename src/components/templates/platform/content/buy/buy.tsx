...
export default function Buy() {
  ...
  const [buyCompleteModal, setBuyCompleteModal] = useState<Omit<IBuyCompleteModalProps, 'onClose'>>({
    isOpen: false,
  });
  ...
  const handleBuySubmit = () => {
    ...
    const minAmount = data?.data.mumm_rcpmny_am || 0;
    const maxAmount = data?.data.mxmm_rcpmny_am || 0;
  ...
  return (
    <>
          ...
          <div className={'max-w-[1080px] mx-auto px-3 sm:px-0'}>
                ...
                <div className={'h-[38px] flex flex-row gap-1.5 px-[10px] bg-gray-95 rounded-lg items-center'}>
                  ...
                  <div className={'font-suit-13-400-130 text-gray-0'}>
                    ...
                    <span className={'text-gray-0 font-suit-15-700-130'}>
                      {(data?.data.mumm_rcpmny_am || 0).toLocaleString('ko-KR')}
                    </span>
                    , 최대 구매 수량은{' '}
                    <span className={'text-gray-0 font-suit-15-700-130'}>
                      {(data?.data.mxmm_rcpmny_am || 0).toLocaleString('ko-KR')}
                    </span>
                    입니다.
                  </div>
                </div>
            ...
            <div className={'pb-5'}>
              ...
              <div className={'pt-5 pb-10'}>
                ...
                <div className={' flex justify-between items-center py-5'}>
                  <div className={'text-gray-20 font-suit-18-b-130'}>구매 수량</div>
                  <div className={'text-orange-orange50 font-suit-24-750-130'}>
      ...
      <BuyCompleteModal {...buyCompleteModal} onClose={() => setBuyCompleteModal({ isOpen: false })} />
      ...
      <ConfirmColModal
        ...
        content={
          <div className={'flex flex-col items-center gap-2.5'}>
            <div className={'relative w-[150px] h-[142px]'}>
              <Image src={digitalCoinCartIcon} alt={'digital-coin-cart-icon'} quality={100} fill />
            </div>

            <div className={'text-gray-10 font-suit-20-r-130'}>구매등록</div>

            <div className={'text-gray-30 font-suit-16-r-130'}>구매 등록을 진행하시겠습니까?</div>
          </div>
        }
        confirmText={'구매'}
        cancelText={'취소'}
