...
export default function TransactionHistoryCA() {
  ...
  const statisticsData = data?.data?.map(
    (item, index) =>
      ...
      }) satisfies ITransactionHistoryCATableData,
  );
      ...
      <div className={'w-full h-full bg-gray-100'}>
        <div className={'flex flex-col gap-5'}>
          ...
          <div className={'flex flex-col gap-8 mx-4'}>
            <Filter select={filterSelect} category={category} />
            ...
            <div className={'flex gap-3 flex-col justify-center items-start text-gray-0 font-pre-16-m-130'}>
              ...
              <TransactionHistoryCATable data={statisticsData} />
