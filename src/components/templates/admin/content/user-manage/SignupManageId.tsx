    ...
    <>
      <div className={'w-full h-full text-gray-0 bg-gray-100'}>
        <div className={'flex flex-col gap-5 mt-5 mx-4'}>
          <AdminHeadline title={'CA 회원 정보 수정'} subTitle={['회원 관리', '회원가입 관리', '회원가입 정보']} />
            ...
            <div className={'w-full flex flex-col gap-5 bg-gray-95 p-5 rounded-[30px]'}>
              <div className={'flex flex-col gap-5'}>
                <div className={'flex justify-between items-center bg-gray-100 py-4 px-5 rounded-[20px]'}>
                  ...
                  <div className={'text-purple-fmg60 font-pre-28-b-130'}>{0}</div>
                </div>
                ...
                <div className={'flex flex-col gap-2.5 p-5 bg-gray-100 rounded-[20px]'}>
                  ...
                  <div className={'h-[152px] flex flex-row gap-2.5 pt-5'}>
                    ...
                    >
                      ...
                      <div className={'flex justify-center items-center text-primary-60 font-pre-24-b-130'}>0</div>
                    </div>
                    ...
                    >
                      ...
                      <div className={'flex justify-center items-center text-orange-orange50 font-pre-24-b-130'}>0</div>
                    </div>
                    ...
                    >
                      ...
                      <div className={'flex justify-center items-center text-green-50 font-pre-24-b-130'}>0</div>
                    </div>
                  </div>
                </div>
