...
import { PurchaseCACoinHistoryModal } from '../modal';
...
export default function PurchaseCATable({ data }: IPurchaseCATableProps) {
  ...
  const handleSingleSendCoin = (item: IPurchaseCATableData) => {
