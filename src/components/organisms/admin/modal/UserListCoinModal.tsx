        ...
        <div className={'flex flex-col gap-[30px] pt-2 px-[10px]'}>
          ...
          <div>
            ...
            <div className={'flex justify-between items-center gap-2'}>
              <input
                className={'w-full py-4 px-3.5 border border-gray-80 rounded-2xl'}
                type={'text'}
              ...
              <button
                className={
                  'w-[90px] h-12 flex items-center justify-center text-gray-100 border border-gray-0 bg-gray-0 rounded-[14px]'
                }
                onClick={handleReset}
              >
                초기화
          ...
          <div className={'grid grid-cols-4 gap-2'}>
            <button
              className={'h-10 text-gray-0 border border-gray-0 rounded-xl'}
          ...
          <div>
            ...
            <textarea
              className={
                'w-full p-4 border border-gray-80 rounded-2xl text-gray-10 placeholder:text-gray-50 font-pre-15-r-130'
              }
              placeholder={'입력'}
              value={memo}
          ...
          <div className={'flex items-center justify-end gap-2'}>
            <button
              className={'w-20 h-12 text-gray-0 font-pre-16-m-130 border border-gray-80 rounded-[60px] px-4'}
              onClick={handleClose}
            >
              취소
            </button>
            ...
            <button
              className={`w-20 h-12 text-gray-100 font-pre-16-m-130 ${
