...
import type { ISaleCACoinHistoryModalProps } from './SaleCACoinHistoryModal.types';
...
export default function SaleCACoinHistoryModal(props: ISaleCACoinHistoryModalProps) {
  ...
  const fetchCoinHistory = useCallback(
    () =>
      adminSaleManagerHistoryService({
  ...
  const coinPurchaseHistoryData = data?.data.map((item) => ({
    ...
    purchaseCompleteCount: item.pymnt_am,
      ...
      <div className={'flex flex-col gap-[30px] px-2.5'}>
        ...
        <div className={'flex flex-row gap-6'}>
          ...
          <div className={'flex-1'}>
            <div className={'h-30 flex flex-col justify-between p-5 border rounded-2xl'}>
