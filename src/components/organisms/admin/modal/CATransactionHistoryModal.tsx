...
import type { ICATransactionHistoryModalProps } from './CATransactionHistoryModal.types';
...
export default function CATransactionHistoryModal(props: ICATransactionHistoryModalProps) {
  ...
  const fetchStatistics = useCallback(
    () =>
      adminManagerDetailHistoryService({
        mngr_id: transactionHistoryTableData?.managerId,
        page: 1,
      ...
      <div className={'flex flex-col gap-[30px] px-2.5'}>
        ...
        <div className={'flex flex-row gap-6'}>
          <div className={'w-[220px] flex flex-col gap-[2px]'}>
            ...
            <div className={'font-suit-24-b-130 text-gray-0'}>{transactionHistoryTableData?.partnerName}</div>
          </div>
          ...
          <div className={'flex-1'}>
            <div className={'h-[120px] flex flex-col justify-between p-5 border rounded-2xl'}>
              <div className={'flex flex-row justify-between items-center'}>
                ...
                <div className={'font-pre-16-r-130 text-gray-0'}>{transactionHistoryTableData?.codeName}</div>
              </div>
              ...
              <div className={'flex flex-row justify-between items-center'}>
                ...
                <a
                  className={'font-pre-16-r-130 text-primary-50 underline'}
                  target={'_blank'}
                  rel={'noreferrer'}
                  href={transactionHistoryTableData?.partnerUrl}
                >
                  {transactionHistoryTableData?.partnerUrl}
                </a>
              </div>
            </div>
          </div>
