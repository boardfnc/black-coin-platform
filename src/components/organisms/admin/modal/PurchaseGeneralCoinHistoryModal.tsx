...
import type { IPurchaseGeneralCoinHistoryModalProps } from './PurchaseGeneralCoinHistoryModal.types';
...
export default function PurchaseGeneralCoinHistoryModal(props: IPurchaseGeneralCoinHistoryModalProps) {
  ...
  const fetchCoinHistory = useCallback(
    () =>
      adminPurchaseMemberHistoryService({
            ...
            <div className={'h-[120px] flex flex-col justify-between p-5 border rounded-2xl'}>
              ...
              <div className={'flex flex-row justify-between items-center'}>
                ...
                <div className={'font-pre-16-r-130 text-gray-0'}>
                  {convertMembershipGrade(coinHistoryModalTableData.authorRank)}
                </div>
              </div>
